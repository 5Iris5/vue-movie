<template>
    <div id="detail_container" class="slide-enter-active">
        <Header title="影片详情">
		...
		<div id="content" class="contentDetail">
            ...
            <div class="detail_list">
				...
				<div class="detail_list_content">
					<div class="detail_list_img">
						<img :src="movieDetail.img | setWH('128.207')" alt="">
					</div>
					<div class="detail_list_info">
			...
			<div class="detail_player swiper-container" ref="detail_player">
				<ul class="swiper-wrapper">
					<li class="swiper-slide" v-for="(item, index) in movieDetail.photos" :key="index">
						<div>
							<img :src="item | setWH('128.170')" alt="">
						</div>
					</li>
				</ul>
			</div>
...
<style scoped>
    #detail_container{ position: absolute; top: 0; left: 0; z-index: 100; width: 100%; min-height: 100%; background-color: #fff; }
	#detail_container.slide-enter-active{ animation: slideMove 1.5s }
	@keyframes slideMove {
